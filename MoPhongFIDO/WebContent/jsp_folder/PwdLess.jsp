...
<!-- 		<script src='http://mrdoob.github.com/three.js/build/three.min.js'></script> -->
		...
		<script src="${pageContext.request.contextPath}/jsp_folder/js/uafReg.js"></script>
...
<%-- 			<script src="${pageContext.request.contextPath}/jsp_folder/js/bootstrap.min.js"></script> --%>
	...
	<body>
		<div style="text-align:center">
			<h1>ĐĂNG KÝ TÀI KHOẢN FIDO UAF</h1>
   		...
   		<div id="prompt" style="width:100%; height:6%; bottom:0; text-align:center; display:none">
			<div class="contentarea">
			    <h1>
			        Lấy ảnh khuôn mặt đăng ký tài khoản 
			    </h1>
		...
		<div id="prompt2" style="width:100%; height:6%; bottom:0; text-align:center; display:none">
			<div class="contentarea">
			    <h1>
