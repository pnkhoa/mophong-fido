...
var steps = [{stepId:0, stepImg:'./jsp_folder/images/fidou2fReg1.png',	stepDes:'', from:userPos, 	to:clientPos},
             {stepId:1, stepImg:'./jsp_folder/images/fidou2fReg2.png',	stepDes:'', from:clientPos, to:serverPos},
	         {stepId:2, stepImg:'./jsp_folder/images/fidou2fReg3.png',	stepDes:'', from:serverPos, to:serverPos},
	         {stepId:3, stepImg:'./jsp_folder/images/fidou2fReg4.png',	stepDes:'', from:serverPos, to:clientPos},
	         {stepId:4, stepImg:'./jsp_folder/images/fidou2fReg5.png',	stepDes:'', from:clientPos, to:clientPos},
	         {stepId:5, stepImg:'./jsp_folder/images/fidou2fReg6.png',	stepDes:'', from:clientPos, to:userPos},
	         {stepId:6, stepImg:'./jsp_folder/images/fidou2fReg7.png',	stepDes:'', from:userPos, 	to:userPos},
	         {stepId:7, stepImg:'./jsp_folder/images/fidou2fReg8.png',	stepDes:'', from:userPos, 	to:userPos},
	         {stepId:8, stepImg:'./jsp_folder/images/fidou2fReg9.png',	stepDes:'', from:userPos, 	to:clientPos},
	         {stepId:9, stepImg:'./jsp_folder/images/fidou2fReg10.png',	stepDes:'', from:clientPos, to:serverPos},
	         {stepId:10,stepImg:'./jsp_folder/images/fidou2fReg11.png',	stepDes:'', from:serverPos, to:serverPos},
	         {stepId:11,stepImg:'./jsp_folder/images/fidou2fReg12.png',	stepDes:'', from:serverPos, to:clientPos}];
var controls = [];
...
function goSteps(){
	...
	var go = setInterval(function(){
		...
		setTimeout(function(){
			...
			if(step>=12)
				{clearInterval(go);
				//alert("Bạn vừa xem phần trình diễn đăng ký tài khoản FIDO U2F. Vui lòng thực hiện phần khảo sát ý kiến người dùng để chúng tôi được phục vụ bạn tốt hơn. Xin cảm ơn!");
				if (window.confirm('Bạn vừa xem phần trình diễn đăng ký tài khoản FIDO U2F. Vui lòng thực hiện phần khảo sát ý kiến người dùng để hệ thống được hoàn thiện hơn.\nChọn OK để đi đến phần khảo sát. Chọn CANCEL để ở lại trang mô phỏng.\nXin Cảm ơn!' )) 
				{
