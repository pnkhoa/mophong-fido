...
{	
    ...
    this.addObject(H2U3);
    controls.push({control:H2U3, icon:'./jsp_folder/images/Howtouseu2f3.png'});
    ...
    this.addObject(H2U2);
    controls.push({control:H2U2, icon:"./jsp_folder/images/Howtouseu2f2.png"});
    ...
    this.addObject(H2U1);
    controls.push({control:H2U1, icon:"./jsp_folder/images/Howtouseu2f1.png"});
