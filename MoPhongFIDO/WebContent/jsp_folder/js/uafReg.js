...
function setImageToIcon(id){
	...
	if(id== -1){ //use default image
		...
		setTimeout(function(){//step 7
			controls[id1].control.mesh.material = new THREE.MeshPhongMaterial( 
		    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
		    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg7.png") } );
			...
			setTimeout(function(){ //step 5.
				...
				setTimeout(function(){ //step 8.
					controls[id1].control.mesh.material = new THREE.MeshPhongMaterial( 
				    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
				    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg8.png") } );
					...
					setTimeout(function(){ //step 8.
						...
						setTimeout(function(){ //step 9.
							controls[id1].control.mesh.material = new THREE.MeshPhongMaterial( 
						    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
						    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg9.png") } );
...
{	
    ...
    info.init({ id : Control.ID_FIDOUSER, icon : "./jsp_folder/images/fidouser2.png", position:[0,0,2] });
    this.addObject(info);
   ...
   clock.init({ id : Control.ID_FIDOSERVER, icon : "./jsp_folder/images/fidoServer3.png", position:[4,3,0] });
...
{
	//console.log(this);
	if(this.id == Control.ID_FIDOUSER){
		this.movingComment();
		return;
	}
//	if (!this.selected)
...
Control.prototype.movingComment = function(){
	...
	var id = Control.ID_RUNNING;
	
		controls[id].control.mesh.material = new THREE.MeshPhongMaterial( 
	    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
	    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg1.png") } );
		...
		setTimeout(function(){ //step 1.
			...
			setTimeout(function(){ //step 2.
				controls[id].control.mesh.material = new THREE.MeshPhongMaterial( 
			    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
			    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg2.png") } );
				...
				setTimeout(function(){ //step 2.
					...
					setTimeout(function(){ //step 3.
						controls[id].control.mesh.material = new THREE.MeshPhongMaterial( 
					    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
					    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg3.png") } );
						...
						setTimeout(function(){ //step 3.
							...
							controls[id].control.deselect1(4,3,0);
							
							setTimeout(function(){ //step 4.
								controls[id].control.mesh.material = new THREE.MeshPhongMaterial( 
							    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
							    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg4.png") } );
								...
								setTimeout(function(){ //step 4.
									...
									setTimeout(function(){ //step 5.
										controls[id].control.mesh.material = new THREE.MeshPhongMaterial( 
									    		{ color: 0xffffff, ambient: 0xababab, transparent:true, 
									    			map:THREE.ImageUtils.loadTexture("./jsp_folder/images/fidouafReg5.png") } );
