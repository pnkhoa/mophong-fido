...
{	
	...
	var cube = new Cube();
	cube.init( 3, 2, 1,'Auth','./jsp_folder/images/fidouafauth.png');
	this.addObject(cube);
	
	var cube2 = new Cube();
	cube2.init( -3, 2, 1,'Reg','./jsp_folder/images/fidouafReg.png');
...
Cube.prototype.handleMouseDown = function(x, y, position)
{
	...
	if(this.name == "Auth") //for uaf
	 document.location.href="FIDOuafauth"; 
	else
		document.location.href="FIDOuafReg";
}
