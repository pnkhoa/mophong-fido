...
{	
	...
	var cube = new Cube();
	cube.init( 3, 2, 1,'FIDO U2F','./jsp_folder/images/fidou2f2.png');
	this.addObject(cube);
	
	var cube2 = new Cube();
	cube2.init( -3, 2, 1,'FIDO UAF','./jsp_folder/images/fidouaf4.png');
...
Cube.prototype.handleMouseDown = function(x, y, position)
{
	...
	if(this.name == "FIDO UAF") //for uaf
	 document.location.href="h2uUAF"; 
	else if(this.name == "FIDO U2F") //for uaf
		 document.location.href="h2uU2F"; 
}
