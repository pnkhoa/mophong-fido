...
<!-- 		<script src='http://mrdoob.github.com/three.js/build/three.min.js'></script> -->
		...
		<script src="${pageContext.request.contextPath}/jsp_folder/js/u2f.js"></script>
...
<%-- 			<script src="${pageContext.request.contextPath}/jsp_folder/js/bootstrap.min.js"></script> --%>
	...
	<body>
		<div style="text-align:center">
			<h1>ĐĂNG KÝ TÀI KHOẢN FIDO U2F</h1>
	...
	<a href="${pageContext.request.contextPath}/">Trang chủ</a> | <a href="${pageContext.request.contextPath}/FIDOu2fReg">Làm mới</a>| <a href="${pageContext.request.contextPath}/Fidou2f">Trở về</a>
	</div>
	</body>
</html>